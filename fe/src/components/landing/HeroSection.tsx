  ...
  return (
    <section className="animate-in fade-in slide-in-from-bottom-12 flex flex-col items-center gap-12 py-20 text-center delay-75 duration-1000">
      <div className="flex max-w-3xl flex-col gap-6">
        <h1 className="font-classic text-5xl font-bold leading-tight text-slate-900 md:text-6xl">
          Viết Lại Lời Bài Hát <br />
          <span className="text-amber-500">Với Trí Tuệ Nhân Tạo</span>
        </h1>
      ...
      <Link
        ...
        className="group relative overflow-hidden rounded-full border border-amber-500 bg-amber-500 px-12 py-4 text-[11px] font-black uppercase tracking-widest text-white transition-all hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(245,158,11,0.5)] active:scale-[0.98]"
      >
