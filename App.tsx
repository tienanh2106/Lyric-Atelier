  ...
  return (
    <div className="min-h-screen flex flex-col items-center selection:bg-amber-500/20">
      <div className="w-full max-w-5xl mx-auto pt-10 pb-32 flex flex-col items-center">
        ...
        />
        {error && (
          <div className="mt-10 px-6 py-4 rounded-xl border border-red-500/10 bg-red-500/5 text-red-500/80 text-[10px] font-black uppercase tracking-widest animate-in fade-in slide-in-from-top-4">
            {error}
          </div>
        )}
      ...
      <footer className="fixed bottom-0 left-0 w-full p-6 border-t border-white/5 bg-black/80 backdrop-blur-2xl z-50">
        <div className="max-w-5xl mx-auto flex justify-between items-center px-4">
          ...
          <span className="text-[9px] font-black text-slate-700 uppercase tracking-widest">© ATELIER PLATINUM 2025</span>
        </div>
      </footer>
    </div>
  );
